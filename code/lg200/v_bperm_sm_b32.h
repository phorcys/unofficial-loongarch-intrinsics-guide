// v_bperm_sm_b32 -- Performs a byte permutation of the 32-bit sources using the workgroup shared-memory permutation state and writes the result to the vector destination
