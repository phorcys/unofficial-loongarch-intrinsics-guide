// load_v_buff_fmtinst_c2 -- Loads 2 formatted components using the instruction format from the buffer descriptor plus the encoded address and offsets into the vector destination
