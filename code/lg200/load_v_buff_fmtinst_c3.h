// load_v_buff_fmtinst_c3 -- Loads 3 formatted components using the instruction format from the buffer descriptor plus the encoded address and offsets into the vector destination
