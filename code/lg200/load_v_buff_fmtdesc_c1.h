// load_v_buff_fmtdesc_c1 -- Loads 1 formatted component using the resource descriptor from the buffer descriptor plus the encoded address and offsets into the vector destination
