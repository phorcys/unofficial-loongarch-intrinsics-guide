// Writes vector channel data to the selected SIO stream. The form uses immediate channel addressing. Stream storage, channel layout, and stage routing follow the graphics SIO ABI.
