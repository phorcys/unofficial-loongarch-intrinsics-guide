// Reads channel data from the selected SIO stream using the encoded rotation. Stream storage, channel layout, and stage routing follow the graphics SIO ABI.
