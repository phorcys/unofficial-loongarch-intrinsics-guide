// atomic_v_flat_cmpswap_b64 -- CPU oracle and case vectors.
#include "ops/oracle_macros.hpp"

LG200_ORACLE_BEGIN(atomic_v_flat_cmpswap_b64, 6)
#include "atomic_v_flat_cmpswap_b64.h"
LG200_ORACLE_END(4)

LG200_CASE_BEGIN(atomic_v_flat_cmpswap_b64)
