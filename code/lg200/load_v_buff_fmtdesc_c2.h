// load_v_buff_fmtdesc_c2 -- Loads 2 formatted components using the resource descriptor from the buffer descriptor plus the encoded address and offsets into the vector destination
