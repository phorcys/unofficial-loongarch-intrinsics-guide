// v_max3_f32 -- Selects the greatest of the three sources and writes the result to the vector destination
// [HW 2026-08-24] f32 denormal inputs flush to signed zero before
// max3 (hardware compares flushed operands).
...
dst[0] = f32_max3(a0, a1, a2, policy);
