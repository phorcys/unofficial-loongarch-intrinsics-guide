// Writes vector channel data to the selected SIO stream using the encoded rotation. The form uses an explicit stream identifier. Stream storage, channel layout, and stage routing follow the graphics SIO ABI.
