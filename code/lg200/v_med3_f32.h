// v_med3_f32 -- Selects the median of the three sources and writes the result to the vector destination
// [HW 2026-08-24] f32 denormal inputs flush to signed zero before
// med3 (hardware compares flushed operands).
...
dst[0] = f32_med3(a0, a1, a2, policy);
