// load_v_buff_fmtinst_c4 -- Loads 4 formatted components using the instruction format from the buffer descriptor plus the encoded address and offsets into the vector destination
