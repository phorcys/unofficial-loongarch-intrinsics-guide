// load_v_buff_fmtdesc_c3 -- Loads 3 formatted components using the resource descriptor from the buffer descriptor plus the encoded address and offsets into the vector destination
