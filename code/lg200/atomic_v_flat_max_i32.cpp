// atomic_v_flat_max_i32 -- CPU oracle and case vectors.
#include "ops/oracle_macros.hpp"

LG200_ORACLE_BEGIN(atomic_v_flat_max_i32, 2)
#include "atomic_v_flat_max_i32.h"
LG200_ORACLE_END(2)

LG200_CASE_BEGIN(atomic_v_flat_max_i32)
