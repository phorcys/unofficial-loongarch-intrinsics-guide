// Reads channel data from the selected SIO stream into the vector destination. Stream storage, channel layout, and stage routing follow the graphics SIO ABI.
