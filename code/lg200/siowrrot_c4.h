// Writes vector channel data to the selected SIO stream using the encoded rotation. The form uses a four-channel transfer. Stream storage, channel layout, and stage routing follow the graphics SIO ABI.
